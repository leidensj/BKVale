...
QT_MOC_LITERAL(1, 17, 23), // "calculatorButtonClicked"
QT_MOC_LITERAL(2, 41, 0), // ""
QT_MOC_LITERAL(3, 42, 18), // "Calculator::Button"
QT_MOC_LITERAL(4, 61, 6) // "button"

    },
    "CalculatorWidget\0calculatorButtonClicked\0"
    "\0Calculator::Button\0button"
};
#undef QT_MOC_LITERAL
...
void CalculatorWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->calculatorButtonClicked((*reinterpret_cast< Calculator::Button(*)>(_a[1]))); break;
        default: ;
        }
    }
}
