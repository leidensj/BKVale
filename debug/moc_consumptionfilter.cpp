...
QT_MOC_LITERAL(3, 33, 19), // "Consumption::Filter"
QT_MOC_LITERAL(4, 53, 6), // "filter"
QT_MOC_LITERAL(5, 60, 17), // "emitChangedSignal"
QT_MOC_LITERAL(6, 78, 14) // "enableControls"

    },
    "ConsumptionFilter\0changedSignal\0\0"
    "Consumption::Filter\0filter\0emitChangedSignal\0"
    "enableControls"
};
...
void ConsumptionFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changedSignal((*reinterpret_cast< const Consumption::Filter(*)>(_a[1]))); break;
        ...
        {
            typedef void (ConsumptionFilter::*_t)(const Consumption::Filter & );
...
// SIGNAL 0
void ConsumptionFilter::changedSignal(const Consumption::Filter & _t1)
{
