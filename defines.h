...
#define PERSON_FILTER_CUSTOMER PERSON_SQL_COL11 " = TRUE"
#define PERSON_FILTER_SUPPLIER PERSON_SQL_COL12 " = TRUE"
#define PERSON_FILTER_EMPLOYEE PERSON_SQL_COL13 " = TRUE"
